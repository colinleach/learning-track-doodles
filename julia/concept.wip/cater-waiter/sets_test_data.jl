...
recipes_without_duplicates  =  [("kisir_with_warm_pita", "Kisir with Warm Pita", Set(["water", "chopped parsley", "pomegranate molasses", "spring onion", "lemon juice", "olive oil", "bulgur", "tomato paste", "tomato", "persian cucumber"])),
                             ("shakshuka", "Shakshuka", Set(["smoked paprika", "tomatoes", "cumin", "firm tofu", "olive oil", "harissa", "yellow onion", "sugar", "za'atar", "tomato paste", "cloves", "red bell pepper", "vegan unsweetened yoghurt"])),
                             ("vegetarian_khoresh_bademjan", "Vegetarian Khoresh Bademjan", Set(["pomegranate concentrate", "saffron powder", "cayenne pepper", "barberries", "salt", "yellow onions", "yellow split peas", "slivered almonds", "ground turmeric", "orange zest", "lemon juice", "kosher salt", "hot water", "basmati rice", "black pepper", "orange juice", "tomato paste", "vegan butter", "chinese eggplants"])),
                             ("baked_kelewele", "Baked Kelewele", Set(["salt", "coconut oil", "smoked paprika", "cayenne pepper", "red onion", "fresh ginger", "calabash nutmeg", "grains of selim", "black peppercorn", "cloves", "ripe plantains"])),
                             ("waakye", "Waakye", Set(["salt", "coconut oil", "water", "white rice", "sorghum stems", "black-eyed peas", "baking soda"])),
                             ("georgian_eggplant_rolls_with_walnuts", "Georgian Eggplant Rolls with Walnuts", Set(["salt", "coriander", "pomegranate seeds", "oil", "water", "vinegar", "garlic", "eggplants", "black pepper", "khmeli suneli", "walnuts"])),
                             ("burmese_tofu_with_garlic,_ginger_and_chili_sauce", "Burmese Tofu with Garlic, Ginger and Chili Sauce", Set(["salt", "rice vinegar", "oil", "water", "turmeric", "chili flakes", "spring onions", "brown sugar", "garlic", "chickpea flour", "ginger", "soy sauce", "peanuts"])),
                             ("celeriac_schnitzel", "Celeriac Schnitzel", Set(["salt", "parsley", "water", "sunflower oil", "flour", "breadcrumbs", "lemon", "celeriac", "chickpea flour", "soy sauce", "black pepper"])),
                             ("sticky_lemon_tofu", "Sticky Lemon Tofu", Set(["salt", "water", "tofu", "cornstarch", "vegetable stock", "vegetable oil", "lemon juice", "garlic", "black pepper", "ginger", "soy sauce", "sugar", "lemon zest"])),
                             ("vegan_carbonara", "Vegan Carbonara", Set(["salt", "turmeric", "spaghetti", "lemon juice", "olive oil", "garlic", "black pepper", "nutritional yeast", "soy sauce", "smoked tofu", "silken tofu", "mixed herbs"])),
                             ("vegan_pizza_with_caramelized_onions", "Vegan Pizza with Caramelized Onions", Set(["red pepper flakes", "garlic", "cashews", "fresh basil", "flour", "tomatoes", "red onion", "oregano", "nutritional yeast", "rosemary", "water", "bell pepper", "honey", "barley malt", "olive oil", "salt", "garlic powder", "mushrooms", "yeast", "sugar"])),
                             ("cheela_with_spicy_mango_chutney", "Cheela with Spicy Mango Chutney", Set(["hing", "curry leaves", "mangoes", "garlic", "nigella seeds", "garlic paste", "coriander seeds", "oil", "turmeric", "red chili powder", "coriander powder", "cardamom powder", "turmeric powder", "clove powder", "water", "cumin powder", "fresh ginger", "vinegar", "cinnamon powder", "cilantro", "chickpea flour", "onion", "salt", "mango powder", "fresh red chili", "mashed potatoes", "mustard seeds", "serrano chili", "garam masala", "sugar"])),
                             ("sweet_and_spicy_crispy_green_beans", "Sweet and Spicy Crispy Green Beans", Set(["sesame oil", "siracha", "sunflower oil", "pomegranate molasses", "sesame seeds", "green beans", "carrot", "scallions", "garlic", "ginger", "soy sauce", "tomato paste", "bell pepper"])),
                             ("vegan_mini_savory_mince_pies", "Vegan Mini Savory Mince Pies", Set(["apples", "brandy", "pecans", "raisins", "brown sugar", "lemon zest", "dried blueberries", "vegetarian worcestershire sauce", "orange zest", "butternut squash", "corn flour", "rosemary", "vegetable stock", "carrot", "figs", "cinnamon powder", "olive oil", "orange juice", "black pepper", "onion", "dried cherries", "salt", "dried cranberries", "parev shortcrust pastry", "mushrooms", "allspice powder", "lemon juice", "ginger", "currants"])),
                             ("roasted_corn_and_zucchini_salad", "Roasted Corn and Zucchini Salad", Set(["zucchini", "tomatoes", "green onions", "corn", "lemon juice", "olive oil", "black pepper", "lemon zest", "dill"])),
                             ("golden_potato_salad", "Golden Potato Salad", Set(["salt", "yukon gold potato", "turmeric", "balsamic vinegar", "cumin seeds", "lemon juice", "olive oil", "garlic", "mustard seeds", "black pepper", "chives"])),
                             ("carrot_puff_pastry_tart", "Carrot Puff Pastry Tart", Set(["salt", "water", "lemon", "thyme", "red onion", "carrot", "lemon juice", "pareve puff pastry", "ground almonds", "brown sugar", "olive oil", "garlic", "black pepper", "vegan butter"])),

                             ("mushroom_lasagna", "Mushroom Lasagna", Set(["dried lasagna noodles", "portobello mushrooms", "nutmeg", "flour", "kosher salt", "milk", "olive oil", "garlic", "onions", "butter", "black pepper", "parmesan cheese"])),
                             ("nut_wellington", "Nut Wellington", Set(["apples", "eggs", "hazelnuts", "pecans", "thyme", "dates", "cashews", "breadcrumbs", "almonds", "marmite", "sage", "leeks", "olive oil", "black pepper", "walnuts", "salt", "chestnuts", "brazil nuts", "butter", "puff pastry sheets"])),
                             ("white_cheddar_scalloped_potatoes", "White Cheddar Scalloped Potatoes", Set(["yukon gold potato", "shallots", "cream", "thyme", "breadcrumbs", "sharp white cheddar", "kosher salt", "milk", "garlic"])),
                             ("winter_cobb_salad", "Winter Cobb Salad", Set(["lacinato kale", "eggs", "red wine vinegar", "shiitake mushrooms", "tomatoes", "avocados", "olive oil", "blue cheese", "garlic", "black pepper", "onion", "smoked tofu"])),
                             ("roast_pumpkin_and_lentil_salad_with_roasted_lemon_dressing", "Roast Pumpkin and Lentil Salad with Roasted Lemon Dressing", Set(["red wine vinegar", "dijon mustard", "lemon", "honey", "red onion", "feta cheese", "olive oil", "capers", "pepitas", "fresh pumpkin", "watercress", "green lentils", "currants"])),
                             ("cambodian-style_vegetable_spring_rolls", "Cambodian-Style Vegetable Spring Rolls", Set(["sunflower oil", "vegetarian fish sauce", "shallots", "vermicelli noodles", "wombok", "firm tofu", "lime juice", "corn flour", "palm sugar", "bean sprouts", "spring roll wrappers", "garlic", "red chili", "soy sauce", "toasted peanuts", "carrot"])),
                             ("summer_minestrone_cups", "Summer Minestrone Cups", Set(["leek", "garlic", "lemon zest", "tomatoes", "red chili", "chickpeas", "rosemary", "carrot", "vegetable bullion", "fresh corn", "fresh peas", "green beans", "olive oil", "parmesan cheese", "croutons", "celery", "mint", "basil", "green lentils", "parmesan rind"])),
                             ("fried_zucchini_with_balsamic_and_chili_dressing", "Fried Zucchini with Balsamic and Chili Dressing", Set(["zucchini", "balsamic vinegar", "honey", "red onion", "lemon juice", "olive oil", "mint leaves", "garlic", "red thai chili", "pomegranate"])),
                             ("barley_risotto", "Barley Risotto", Set(["beets", "white wine", "thyme", "red onion", "carrot", "butternut squash", "olive oil", "sage", "garlic", "brussel sprouts", "rosemary", "black pepper", "parmesan cheese", "pearl barley", "vegetable bullion"])),
                             ("cherry_tomato,_watercress_and_fava_bean_salad", "Cherry Tomato, Watercress and Fava Bean Salad", Set(["salt", "fresh or frozen fava beans", "fresh peas", "balsamic vinegar", "olive oil", "garlic", "watercress", "fresh cherry bocconcini", "fresh cherry tomatoes"])),
                             ("fresh_garden_peas_over_cauliflower_almond_puree", "Fresh Garden Peas over Cauliflower Almond Puree", Set(["grated nutmeg", "red onions", "lemon", "fresh peas", "cream", "vegetable oil", "olive oil", "garlic", "blanched almonds", "cauliflower", "fresh pea tendrils"])),
                             ("walnut_ravioli_with_artichokes_and_tomatoes", "Walnut Ravioli with Artichokes and Tomatoes", Set(["salt", "fresh tomatoes", "ricotta cheese", "lemon zest", "olives", "red onion", "lemon juice", "black pepper", "rosemary", "butter", "basil", "fresh artichoke hearts", "pasta sheets", "pine nuts", "walnuts", "oil marinated artichokes"])),
                             ("asparagus_puffs", "Asparagus Puffs", Set(["salt", "asparagus", "ricotta cheese", "thyme", "puff pastry", "red onion", "eggs", "lemon juice", "black pepper", "parmesan cheese", "chives"])),
                             ("grilled_tofu_tacos", "Grilled Tofu Tacos", Set(["carrot", "red cabbage", "ancho chili", "limes", "hot water", "garlic", "roasted corn", "masa", "pasilla chili", "lemon", "tomatoes", "cumin", "fresh cilantro leaves", "chipotle chili", "red onions", "pepitas", "tomatillos", "black beans", "cotija cheese", "crema", "firm tofu", "lemon juice", "jalapeño chili", "avocado"])),

                             ("zucchini_fritters_with_lemon-thyme_coconut_yogurt", "Zucchini Fritters with Lemon-Thyme Coconut Yogurt", Set(["salt", "coconut oil", "eggs", "fresh thai chili", "coconut yogurt", "zucchini", "lemon juice", "black pepper", "coconut flour", "chives", "lemon zest", "baking soda"])),
                             ("avocado_deviled_eggs", "Avocado Deviled Eggs", Set(["salt", "eggs", "garlic powder", "seranno chili", "avocado", "lime juice", "pepitas", "fresh cilantro leaves"])),
                             ...
                             ("pumpkin_bread_crostini", "Pumpkin Bread Crostini", Set(["eggs", "nutmeg", "cinnamon", "garlic", "pumpkin puree", "apple cider vinegar", "cherry tomatoes", "onions", "coconut flour", "cloves", "shrimp", "coconut oil", "honey", "olive oil", "black pepper", "almond butter", "salt", "fresh red chili", "basil", "baking soda"])),
                             ("blt_bites", "BLT Bites", Set(["paleo mayonnaise", "bacon", "kale", "cherry tomatoes", "mustard seed", "onion"])),
                             ("roasted_chicken_with_roasted_tomatoes,_avocado,_and_sweet_potatoes", "Roasted Chicken with Roasted Tomatoes, Avocado, and Sweet Potatoes", Set(["safflower oil", "shallots", "whole chicken", "lemons", "tomatoes", "purple sweet potato", "avocados", "limes", "kosher salt", "olive oil", "mexican oregano", "garlic", "black pepper", "cumin", "chiles de árbol"])),
                             ("chicken_with_tamarind_and_apricot_sauce", "Chicken with Tamarind and Apricot Sauce", Set(["cinnamon", "garlic", "cider vinegar", "chipotles", "homemade tamarind concentrate", "roma tomatoes", "white chicken", "ground cumin", "water", "safflower oil", "allspice", "dried apricots", "honey", "olive oil", "black pepper", "salt", "homemade apricot honey preserves", "kosher salt", "chili powder"])),
                             ("grilled_fish_tacos_with_cauliflower_tortillas", "Grilled Fish Tacos with Cauliflower Tortillas", Set(["salt", "eggs", "smoked paprika", "shredded red cabbage", "mango", "green onions", "lime", "cumin", "tilapia", "cilantro", "black pepper", "serrano chili", "cauliflower", "avocado"])),
                             ("grilled_pork_chops_with_mango_pineapple_salsa", "Grilled Pork Chops with Mango Pineapple Salsa", Set(["pork chops", "lacinato kale", "chipotle chili", "serrano chili", "lime zest", "pineapple", "lime", "garlic", "onions", "mangoes", "cauliflower", "avocado", "cilantro leaves"])),
                             ("grilled_shrimp_and_pesto_over_zucchini_noodles", "Grilled Shrimp and Pesto over Zucchini Noodles", Set(["salt", "green bell pepper", "cashews", "zucchini", "tomatoes", "red bell pepper", "cumin", "lemon juice", "yellow bell pepper", "olive oil", "garlic", "pine nuts", "basil", "lemon zest", "shrimp"])),

                             ("cauliflower_pizza_with_roasted_tomatoes_and_chicken", "Cauliflower Pizza with Roasted Tomatoes and Chicken", Set(["roasted chicken", "eggs", "fresh basil", "olive oil", "almond meal", "cherry tomatoes", "rosemary", "cauliflower", "mozzarella cheese", "tomato paste", "parmesan"])),
                             ("flank_steak_with_chimichurri_and_asparagus", "Flank Steak with Chimichurri and Asparagus", Set(["fresh parsley", "salt", "asparagus", "chipotle chili", "flank steak", "scallions", "olive oil", "garlic", "black pepper", "cauliflower", "white vinegar", "sour cream"])),
                             ("kingfish_lettuce_cups", "Kingfish Lettuce Cups", Set(["oyster sauce", "fish sauce", "spring onions", "sesame seeds", "grilled king fish", "little gem lettuce heads", "mirin", "red cabbage", "lime juice", "peanut oil", "garlic", "watermelon radishes", "soy sauce", "avocado"])),
                             ...
                             ("prawn_and_herb_omelette", "Prawn and Herb Omelette", Set(["salt", "parsley", "eggs", "fresh cucumber", "sesame seeds", "green onions", "monk fruit", "lemon juice", "olive oil", "tahini", "harissa", "black pepper", "butter", "onion", "fennel bulb", "chives", "shrimp", "dill"])),
                             ("satay_steak_skewers", "Satay Steak Skewers", Set(["flank steak", "red and green thai chili", "kecap manis", "fish sauce", "monk fruit", "micro cilantro", "carrot", "apple cider vinegar", "sriacha", "lime juice", "olive oil", "cucumbers", "roasted peanuts", "crunchy peanut butter", "peanuts"])),
                             ...
                             ("seared_salmon_with_pickled_vegetable_and_watercress_salad", "Seared Salmon with Pickled Vegetable and Watercress Salad", Set(["red wine vinegar", "caster sugar", "salmon steaks", "radishes", "shallots", "red onion", "pink peppercorns", "toasted buckwheat", "lemon juice", "lime juice", "red cabbage", "watercress", "fennel seeds", "dutch carrot"])),
                             ("braised_pork_belly_with_apple_salad", "Braised Pork Belly with Apple Salad", Set(["spring onions", "dark soy sauce", "light soy sauce", "pork belly", "monk fruit", "green cabbage", "star anise", "sesame seeds", "lemon juice", "olive oil", "black pepper", "ginger", "cinnamon sticks", "granny smith apples", "cilantro leaves"])),
                             ...
                             ("governor_shrimp_tacos", "Governor Shrimp Tacos", Set(["chile manzano", "worcestershire sauce", "oaxaca cheese", "garlic cloves", "red onion", "avocado", "lime juice", "kosher salt", "white onion", "chipotle adobo sauce", "poblano chili", "fresh corn tortillas", "butter", "black pepper", "pepitas", "tomato paste", "roma tomatoes", "shelled large shrimp"])),
                             ("shrimp,_bacon_and_crispy_chickpea_tacos_with_salsa_de_guacamole", "Shrimp, Bacon and Crispy Chickpea Tacos with Salsa de Guacamole", Set(["fresh tortillas", "slivered almonds", "bacon", "sea salt", "chickpeas", "olive oil", "guajillo chile", "garlic", "butter", "black pepper", "onion", "shrimp", "avocado"])),
                             ("burnt_masala_wings_with_classic_coleslaw", "Burnt Masala Wings with Classic Coleslaw", Set(["mayonnaise", "carrot", "red cabbage", "green cabbage", "apple cider vinegar", "lime juice", "cloves", "cinnamon sticks", "sriracha", "celery seeds", "chicken wings", "garlic cloves", "honey", "olive oil", "cilantro", "black pepper", "chiles de árbol", "tamarind concentrate", "green cardamom", "black cardamom", "lemon juice", "kosher salt", "serrano chili", "ginger", "black peppercorns", "butter"])),
                             ("dahi_puri_with_black_chickpeas", "Dahi Puri with Black Chickpeas", Set(["roasted chicken", "scallion chutney", "yukon gold potato", "turmeric", "black chickpeas", "whole-milk yogurt", "chili powder", "red onion", "pani puri", "ginger", "mint", "thin sev", "date syrup", "cumin", "chaat masala", "tamarind concentrate"])),
                             ("brisket_with_grilled_rhubarb,_onions,_and_fennel", "Brisket with Grilled Rhubarb, Onions, and Fennel", Set(["crushed red pepper flakes", "rhubarb", "thyme", "yellow onion", "garlic", "brown sugar", "beer", "lemon", "red onion", "oregano", "soy sauce", "white vinegar", "beef brisket", "parsley", "marjoram", "balsamic vinegar", "vegetable oil", "fennel bulbs", "cilantro", "black pepper", "worcestershire sauce", "celery", "kosher salt", "mint", "chili powder"])),
                             ("roast_leg_of_lamb_with_crispy_moroccan_carrots_&_couscous", "Roast Leg of Lamb with Crispy Moroccan Carrots & Couscous", Set(["bay leaves", "fresh thyme", "carrot", "tahini", "garlic", "baby carrot", "oranges", "filo pastry", "tomatoes", "harissa", "onions", "rosemary", "leg of lamb", "vegetable bullion", "sesame seeds", "honey", "anchovy fillets", "vinegar", "olive oil", "couscous", "fresh mint", "celery", "yoghurt"])),
                             ("baked_chicken_jollof_rice", "Baked Chicken Jollof Rice", Set(["coriander", "salt", "white pepper", "water", "bell pepper", "turmeric", "rice", "scotch bonnet pepper", "chicken", "thyme", "maggi cubes", "garlic", "ginger", "onion", "tomato", "carrot", "tomato puree"])),
                             ("seafood_risotto", "Seafood Risotto", Set(["white wine", "water", "clams", "crab legs", "baby squid", "lemon juice", "parmesan cheese", "olive oil", "white onion", "garlic", "arborio risotto rice", "fish stock", "mussels", "flat-leaf parsley", "tomato paste", "prawns", "baby scallops", "cherry tomatoes"])),
...
group_1 = filter(item -> item[1] ∈ dupes, recipes_with_duplicates)
group_2 = [(item[2], item[3]) for item in recipes_without_duplicates if item[2] ∈ nondupes]

dishes_to_special_label = sort!(vcat(group_1, group_2))

dishes_labeled =  [("Baked Kelewele", Set(["red onion"])),
                   ("Barley Risotto", Set(["garlic", "red onion", "parmesan cheese"])),
                   ("Brisket with Grilled Rhubarb, Onions, and Fennel", Set(["soy sauce", "garlic", "red onion", "yellow onion"])),
                   ("Burmese Tofu with Garlic, Ginger and Chili Sauce", Set(["soy sauce", "garlic", "peanuts"])),
                   ("Burnt Masala Wings with Classic Coleslaw", Set(["honey", "butter", "garlic cloves"])),
                   ("Butter Chicken with Grilled Mushrooms, Brussel Sprouts and Mango Chutney", Set(["heavy cream", "garlic", "butter", "tomatoes"])),
                   ("Cambodian-Style Vegetable Spring Rolls", Set(["soy sauce", "firm tofu", "garlic", "toasted peanuts"])),
                   ("Cauliflower Pizza with Roasted Tomatoes and Chicken", Set(["parmesan", "mozzarella cheese", "tomato paste", "cherry tomatoes", "eggs"])),
                   ("Dahi Puri with Black Chickpeas", Set(["red onion", "whole-milk yogurt"])),
                   ("Flank Steak with Chimichurri and Asparagus", Set(["garlic"])),
                   ("Fried Zucchini with Balsamic and Chili Dressing", Set(["honey", "garlic", "red onion"])),
                   ("Kingfish Lettuce Cups", Set(["soy sauce", "oyster sauce", "garlic", "grilled king fish"])),
                   ("Kisir with Warm Pita", Set(["bulgur", "tomato paste"])),
                   ("Shakshuka", Set(["tomatoes", "tomato paste", "firm tofu", "yellow onion"])),
                   ("Shrimp, Bacon and Crispy Chickpea Tacos with Salsa de Guacamole", Set(["shrimp", "garlic", "butter", "slivered almonds", "bacon"])),
                   ("Summer Minestrone Cups", Set(["garlic", "tomatoes", "parmesan cheese"])),
                   ("Vegetarian Khoresh Bademjan", Set(["slivered almonds", "tomato paste"]))]
...
ingredients_only = [[Set(["bulgur", "pomegranate molasses", "chopped parsley", "lemon juice", "tomato", "persian cucumber", "tomato paste", "spring onion", "water", "olive oil"]),
                    Set(["vegan unsweetened yoghurt", "yellow onion", "firm tofu", "smoked paprika", "tomatoes", "tomato paste", "sugar", "cloves", "cumin", "za'atar", "olive oil", "harissa", "red bell pepper"]),
                    Set(["yellow split peas", "tomato paste", "black pepper", "pomegranate concentrate", "yellow onions", "slivered almonds", "ground turmeric", "barberries", "basmati rice", "lemon juice", "hot water", "cayenne pepper", "chinese eggplants", "salt", "orange juice", "saffron powder", "vegan butter", "orange zest", "kosher salt"]),
                    Set(["smoked paprika", "black peppercorn", "red onion", "grains of selim", "cayenne pepper", "calabash nutmeg", "coconut oil", "cloves", "fresh ginger", "salt", "ripe plantains"]),
                    Set(["baking soda", "sorghum stems", "coconut oil", "black-eyed peas", "water", "salt", "white rice"]),
                    Set(["pomegranate seeds", "oil", "coriander", "garlic", "khmeli suneli", "eggplants", "black pepper", "vinegar", "walnuts", "water", "salt"]),
                    Set(["soy sauce", "oil", "chili flakes", "garlic", "brown sugar", "ginger", "peanuts", "rice vinegar", "spring onions", "water", "turmeric", "salt", "chickpea flour"]),
                    Set(["soy sauce", "parsley", "lemon", "sunflower oil", "black pepper", "celeriac", "breadcrumbs", "water", "salt", "flour", "chickpea flour"]),
                    Set(["soy sauce", "vegetable stock", "tofu", "cornstarch", "lemon juice", "lemon zest", "garlic", "ginger", "black pepper", "sugar", "water", "salt", "vegetable oil"]),
                    Set(["soy sauce", "smoked tofu", "lemon juice", "nutritional yeast", "mixed herbs", "garlic", "black pepper", "silken tofu", "turmeric", "salt", "olive oil", "spaghetti"]),
                    Set(["mushrooms", "rosemary", "garlic", "red pepper flakes", "yeast", "barley malt", "water", "olive oil", "garlic powder", "oregano", "honey", "nutritional yeast", "red onion", "tomatoes", "cashews", "sugar", "bell pepper", "flour", "salt", "fresh basil"]),
                    Set(["clove powder", "oil", "cinnamon powder", "nigella seeds", "curry leaves", "coriander seeds", "garlic", "mangoes", "mashed potatoes", "cardamom powder", "vinegar", "water", "mustard seeds", "coriander powder", "cumin powder", "mango powder", "garam masala", "red chili powder", "hing", "garlic paste", "turmeric powder", "cilantro", "sugar", "onion", "serrano chili", "fresh ginger", "turmeric", "salt", "fresh red chili", "chickpea flour"]),
                    Set(["soy sauce", "pomegranate molasses", "sesame oil", "green beans", "sunflower oil", "scallions", "garlic", "carrot", "ginger", "sesame seeds", "tomato paste", "bell pepper", "siracha"]),
                    Set(["mushrooms", "cinnamon powder", "rosemary", "corn flour", "ginger", "brown sugar", "carrot", "black pepper", "raisins", "butternut squash", "vegetarian worcestershire sauce", "parev shortcrust pastry", "olive oil", "vegetable stock", "dried cherries", "lemon juice", "lemon zest", "figs", "dried cranberries", "apples", "pecans", "onion", "orange juice", "currants", "dried blueberries", "salt", "brandy", "orange zest", "allspice powder"]),
                    Set(["green onions", "lemon juice", "lemon zest", "dill", "corn", "tomatoes", "black pepper", "zucchini", "olive oil"]),
                    Set(["mustard seeds", "cumin seeds", "lemon juice", "garlic", "black pepper", "balsamic vinegar", "yukon gold potato", "chives", "turmeric", "salt", "olive oil"]),
                    Set(["olive oil", "lemon", "lemon juice", "pareve puff pastry", "brown sugar", "red onion", "carrot", "garlic", "black pepper", "thyme", "vegan butter", "water", "salt", "ground almonds"])
                    ],

                    [Set(["nutmeg", "garlic", "black pepper", "onions", "butter", "parmesan cheese", "portobello mushrooms", "flour", "dried lasagna noodles", "olive oil", "milk", "kosher salt"]),
                    Set(["sage", "puff pastry sheets", "hazelnuts", "almonds", "black pepper", "thyme", "marmite", "breadcrumbs", "walnuts", "dates", "eggs", "olive oil", "brazil nuts", "leeks", "chestnuts", "cashews", "apples", "pecans", "butter", "salt"]),
                    Set(["shallots", "garlic", "cream", "thyme", "breadcrumbs", "sharp white cheddar", "yukon gold potato", "milk", "kosher salt"]),
                    Set(["smoked tofu", "shiitake mushrooms", "red wine vinegar", "garlic", "tomatoes", "black pepper", "avocados", "blue cheese", "onion", "lacinato kale", "eggs", "olive oil"]),
                    Set(["honey", "lemon", "dijon mustard", "feta cheese", "red wine vinegar", "red onion", "watercress", "green lentils", "currants", "capers", "pepitas", "fresh pumpkin", "olive oil"]),
                    Set(["lime juice", "toasted peanuts", "firm tofu", "garlic", "corn flour", "bean sprouts", "carrot", "palm sugar", "shallots", "red chili", "vermicelli noodles", "wombok", "soy sauce", "sunflower oil", "spring roll wrappers", "vegetarian fish sauce"]),
                    Set(["fresh peas", "rosemary", "garlic", "chickpeas", "carrot", "leek", "green lentils", "red chili", "olive oil", "croutons", "fresh corn", "lemon zest", "green beans", "parmesan rind", "basil", "tomatoes", "vegetable bullion", "parmesan cheese", "celery", "mint"]),
                    Set(["honey", "lemon juice", "garlic", "red onion", "red thai chili", "pomegranate", "balsamic vinegar", "mint leaves", "zucchini", "olive oil"]),
                    Set(["sage", "beets", "pearl barley", "brussel sprouts", "rosemary", "garlic", "carrot", "red onion", "black pepper", "thyme", "butternut squash", "vegetable bullion", "parmesan cheese", "olive oil", "white wine"]),
                    Set(["fresh peas", "fresh cherry tomatoes", "garlic", "watercress", "balsamic vinegar", "fresh or frozen fava beans", "fresh cherry bocconcini", "salt", "olive oil"]),
                    Set(["red onions", "lemon", "fresh peas", "garlic", "grated nutmeg", "cream", "cauliflower", "blanched almonds", "fresh pea tendrils", "olive oil", "vegetable oil"]),
                    Set(["pine nuts", "oil marinated artichokes", "olives", "rosemary", "fresh tomatoes", "ricotta cheese", "black pepper", "fresh artichoke hearts", "walnuts", "pasta sheets", "lemon juice", "lemon zest", "basil", "red onion", "butter", "salt"]),
                    Set(["egg", "asparagus", "lemon juice", "red onion", "ricotta cheese", "black pepper", "thyme", "salt", "parmesan cheese", "puff pastry", "chives"]),
                    Set(["cotija cheese", "masa", "fresh cilantro leaves", "jalapeño chili", "chipotle chili", "firm tofu", "garlic", "carrot", "roasted corn", "tomatillos", "pepitas", "ancho chili", "crema", "red onions", "pasilla chili", "lemon", "hot water", "lemon juice", "tomatoes", "avocado", "cumin", "red cabbage", "limes", "black beans"])
                    ],

                    [Set(["baking soda", "coconut flour", "lemon juice", "lemon zest", "eggs", "coconut yogurt", "black pepper", "fresh thai chili", "coconut oil", "chives", "zucchini", "salt"]),
                    Set(["lime juice", "fresh cilantro leaves", "eggs", "seranno chili", "avocado", "pepitas", "salt", "garlic powder"]),
                    Set(["pine nuts", "white vinegar", "chipotle chili", "scallions", "garlic", "paleo parmesan cheese", "black pepper", "avocado oil", "treviso", "olive oil", "radishes", "flank steak", "dijon mustard", "castelfranco radicchio", "worcestershire sauce", "fresh parsley", "cherry tomatoes", "salt", "avocado mayonnaise"]),
                    Set(["coconut flour", "garlic", "black pepper", "cloves", "eggs", "olive oil", "onions", "honey", "apple cider vinegar", "almond butter", "baking soda", "nutmeg", "pumpkin puree", "cinnamon", "shrimp", "basil", "coconut oil", "cherry tomatoes", "salt", "fresh red chili"]),
                    Set(["mustard seed", "onion", "kale", "cherry tomatoes", "bacon", "paleo mayonnaise"]),
                    Set(["purple sweet potato", "chiles de árbol", "garlic", "tomatoes", "safflower oil", "black pepper", "mexican oregano", "avocados", "shallots", "cumin", "olive oil", "lemons", "whole chicken", "limes", "kosher salt"]),
                    Set(["garlic", "black pepper", "dried apricots", "roma tomatoes", "water", "olive oil", "honey", "cinnamon", "ground cumin", "cider vinegar", "chili powder", "safflower oil", "homemade tamarind concentrate", "white chicken", "allspice", "chipotles", "salt", "homemade apricot honey preserves", "kosher salt"]),
                    Set(["green onions", "serrano chili", "shredded red cabbage", "smoked paprika", "mango", "eggs", "black pepper", "cilantro", "cauliflower", "avocado", "lime", "cumin", "salt", "tilapia"]),
                    Set(["cilantro leaves", "lime", "pineapple", "chipotle chili", "garlic", "mangoes", "cauliflower", "avocado", "serrano chili", "pork chops", "lime zest", "lacinato kale", "onions"]),
                    Set(["pine nuts", "shrimp", "green bell pepper", "lemon juice", "basil", "lemon zest", "garlic", "tomatoes", "cashews", "yellow bell pepper", "cumin", "zucchini", "salt", "olive oil", "red bell pepper"])
                    ],

                    [Set(["parmesan", "almond meal", "rosemary", "mozzarella cheese", "roasted chicken", "tomato paste", "cauliflower", "cherry tomatoes", "eggs", "fresh basil", "olive oil"]),
                    Set(["white vinegar", "asparagus", "flank steak", "chipotle chili", "scallions", "garlic", "black pepper", "cauliflower", "sour cream", "fresh parsley", "salt", "olive oil"]),
                    Set(["soy sauce", "watermelon radishes", "lime juice", "fish sauce", "mirin", "little gem lettuce heads", "peanut oil", "garlic", "sesame seeds", "oyster sauce", "spring onions", "avocado", "grilled king fish", "red cabbage"]),
                    Set(["clove powder", "curry leaves", "coriander seeds", "ginger", "cardamom powder", "vinegar", "mustard seeds", "mango powder", "garam masala", "red chili powder", "chicken", "hing", "turmeric powder", "tomatoes", "ginger garlic paste", "fresh greek yogurt", "fresh ginger", "monk fruit", "turmeric", "cashew nuts", "salt", "fresh red chili", "cinnamon powder", "nigella seeds", "whole small crimini mushrooms", "brussel sprouts", "garlic", "mangoes", "heavy cream", "cloves", "coriander powder", "cumin powder", "cardamom", "green chili", "cinnamon", "garlic paste", "red chili flakes", "lemon juice", "cilantro", "butter", "dried fenugreek leaves", "boned chicken"]),
                    Set(["green onions", "parsley", "sesame seeds", "black pepper", "chives", "eggs", "fennel bulb", "tahini", "olive oil", "harissa", "shrimp", "lemon juice", "dill", "butter", "onion", "fresh cucumber", "monk fruit", "salt"]),
                    Set(["sriacha", "apple cider vinegar", "lime juice", "fish sauce", "red and green thai chili", "flank steak", "carrot", "peanuts", "cucumbers", "roasted peanuts", "crunchy peanut butter", "kecap manis", "monk fruit", "micro cilantro", "olive oil"]),
                    Set(["spinach", "parmesan cheese", "coconut flour", "chili flakes", "garlic", "black pepper", "cream cheese", "ghee", "lemon juice", "flaxmeal", "red onion", "salt", "salmon fillets", "pecans", "almond flour", "cumin", "fresh cucumber", "cherry tomatoes", "chives", "avocado mayonnaise"]),
                    Set(["rosemary", "garlic", "black pepper", "thyme", "avocado oil", "eggs", "oregano", "asparagus", "lemon", "dijon mustard", "basil", "castelfranco radicchio", "dill", "butter", "pork chops", "monk fruit", "salt", "avocado mayonnaise"]),
                    Set(["lime juice", "caster sugar", "toasted buckwheat", "lemon juice", "red wine vinegar", "red onion", "dutch carrot", "salmon steaks", "watercress", "pink peppercorns", "shallots", "fennel seeds", "red cabbage", "radishes"]),
                    Set(["cilantro leaves", "green cabbage", "lemon juice", "pork belly", "dark soy sauce", "granny smith apples", "ginger", "light soy sauce", "sesame seeds", "black pepper", "cinnamon sticks", "spring onions", "star anise", "monk fruit", "olive oil"])
                    ],

                    [Set(["lime juice", "salsa", "green bell pepper", "anaheim chili", "black pepper", "olive oil", "yellow mustard", "red bell pepper", "soy sauce", "mexican crema", "mayonnaise", "white onion", "garlic cloves", "fresh corn tortillas", "red onion", "tomatoes", "limes", "worcestershire sauce", "butter", "yellow bell pepper", "salt", "red snapper"]),
                    Set(["lime juice", "poblano chili", "tomato paste", "black pepper", "chipotle adobo sauce", "chile manzano", "roma tomatoes", "pepitas", "oaxaca cheese", "white onion", "shelled large shrimp", "garlic cloves", "fresh corn tortillas", "red onion", "worcestershire sauce", "avocado", "butter", "kosher salt"]),
                    Set(["fresh tortillas", "shrimp", "garlic", "chickpeas", "black pepper", "slivered almonds", "guajillo chile", "bacon", "sea salt", "butter", "onion", "avocado", "olive oil"]),
                    Set(["lime juice", "green cabbage", "chiles de árbol", "green cardamom", "ginger", "carrot", "sriracha", "black pepper", "cinnamon sticks", "celery seeds", "cloves", "black cardamom", "olive oil", "chicken wings", "apple cider vinegar", "mayonnaise", "honey", "black peppercorns", "lemon juice", "garlic cloves", "tamarind concentrate", "cilantro", "butter", "serrano chili", "red cabbage", "kosher salt"]),
                    Set(["whole-milk yogurt", "chaat masala", "ginger", "pani puri", "scallion chutney", "yukon gold potato", "black chickpeas", "thin sev", "date syrup", "red onion", "roasted chicken", "chili powder", "tamarind concentrate", "cumin", "turmeric", "mint"]),
                    Set(["white vinegar", "parsley", "yellow onion", "rhubarb", "garlic", "brown sugar", "black pepper", "thyme", "crushed red pepper flakes", "fennel bulbs", "beer", "marjoram", "vegetable oil", "soy sauce", "oregano", "lemon", "red onion", "chili powder", "cilantro", "beef brisket", "balsamic vinegar", "worcestershire sauce", "celery", "mint", "kosher salt"]),
                    Set(["oranges", "rosemary", "garlic", "anchovy fillets", "couscous", "carrot", "sesame seeds", "fresh thyme", "vinegar", "olive oil", "tahini", "harissa", "onions", "honey", "fresh mint", "leg of lamb", "tomatoes", "baby carrot", "vegetable bullion", "filo pastry", "celery", "bay leaves", "yoghurt"]),
                    Set(["tomato puree", "garlic", "ginger", "tomato", "carrot", "thyme", "white pepper", "water", "maggi cubes", "chicken", "rice", "coriander", "scotch bonnet pepper", "bell pepper", "onion", "turmeric", "salt"]),
                    Set(["garlic", "tomato paste", "baby scallops", "mussels", "water", "crab legs", "olive oil", "baby squid", "fish stock", "lemon juice", "white onion", "arborio risotto rice", "clams", "parmesan cheese", "flat-leaf parsley", "cherry tomatoes", "prawns", "white wine"]),
                    Set(["toasted bread", "rosemary", "hazelnuts", "anchovy fillets", "garlic", "carrot", "summer squash", "black pepper", "red pepper flakes", "vinegar", "sea salt", "zucchini", "olive oil", "onions", "white wine vinegar", "fresh mint", "leg of lamb", "lemon", "fresh ricotta", "sugar", "celery", "bay leaves", "kosher salt"])
                     ]]
